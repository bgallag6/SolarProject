# -*- coding: utf-8 -*-
"""
Created on Tue Mar 20 11:26:33 2018
...
def onclick(event):
    ...
    if ixx > 1. and iyy > 1.:
        ...
        ax2.text(0.006, 10**-0.62, r'$\chi^2$ = {0:0.3f}'.format(chisqrM22*100.), fontsize=font_size, fontname="Times New Roman")
...
if 1:
    ...
    ax1 = plt.gca()
    ax1 = plt.subplot2grid((29,28),(4, 1), colspan=14, rowspan=25)
    ...
    ax2 = plt.subplot2grid((29,28),(1, 17), colspan=9, rowspan=14)
    ax2.loglog()
    ax2.set_xlim(10**-4., 10**-1.3)
    ax2.set_ylim(10**-5, 10**0)  
    ...
    ax3 = plt.subplot2grid((29,28),(15, 17), colspan=9, rowspan=14)
    ax3.loglog()
    ax3.set_xlim(10**-4., 10**-1.3)
    ax3.set_ylim(10**-5, 10**0)  
    ax3.set_title('Weightings: 3x3 Std. Dev.', y = 1.01, fontsize=17)
