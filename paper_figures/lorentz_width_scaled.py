# -*- coding: utf-8 -*-
"""
Created on Wed Apr 18 09:16:24 2018
...
plt.title(r'(d) Lorentz. FWHM [min]; $p$ $<$ %0.3f |  $f_{masked}$ = %0.1f%s' % (mask_thresh, mask_percent, '%'), y = 1.02, fontsize=font_size, fontname="Times New Roman")

cmap = cm.get_cmap('jet_r', 10)                    
    
im = ax.imshow(np.flipud(wid_maskB), cmap = cmap, vmin=h_min, vmax=h_max)
...
#plt.savefig('C:/Users/Brendan/Desktop/%s_%i_%s_maskF3.pdf' % (date, wavelength, names[i]), format='pdf', bbox_inches='tight')
