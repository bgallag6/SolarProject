# -*- coding: utf-8 -*-
"""
Created on Wed Jan 10 09:10:24 2018
...
def onclick(event):
    ...
    m2 = LorentzPowerBase(f_fit, param2[0][iy][ix], param2[1][iy][ix], param2[2][iy][ix], param2[3][iy][ix], param2[4][iy][ix], param2[5][iy][ix]) 
    g2 = Lorentz(f_fit, param2[3][iy][ix], param2[4][iy][ix], param2[5][iy][ix])
    pl2 = PowerLaw(f_fit, param2[0][iy][ix], param2[1][iy][ix], param2[2][iy][ix])
    
    ax2.loglog(f_fit, s, 'black')
    
    ax2.loglog(f_fit, m, 'red', label='M2 [Gaussian]', linewidth=1.5)
    ax2.loglog(f_fit, g, 'r--', label='Gaussian', linewidth=1.5)
    #ax2.loglog(f_fit, pl, 'g', label='Power Law')

    ax2.loglog(f_fit, m2, 'blue', label='M2 [Lorentzian]', linewidth=1.5)
    ax2.loglog(f_fit, g2, 'b--', label='Lorentzian', linewidth=1.5)
    #ax2.loglog(f_fit, pl2, 'r', label='Power Law')
