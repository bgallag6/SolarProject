# -*- coding: utf-8 -*-
"""
Created on Mon Mar 20 16:22:06 2017
...
#for ii in range(0,5):
    ...
    #for jj in range(0,5):        
        ...
        spectra_array[ii][jj] = y2  # construct 3D array with averaged FFTs from each pixel
...
np.save('C:/Users/Brendan/Desktop/testing_171/spectra_2hr_3of3_smoothed.npy', spectra_array)
