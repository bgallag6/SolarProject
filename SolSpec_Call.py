...
ss.datacube(directory='%s' % (directory), date='%s' % (date), wavelength= wavelength, sub_reg_coords=[100,325,200,290], coords_type='arc', bin_frac=1)
...
ss.fft_avg(directory='%s' % (directory), date='%s' % (date), wavelength= wavelength, num_seg = 5)  # 3 seg for 20120923, 6 seg for rest
