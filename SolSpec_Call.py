...
#ss.arc2pix(x1,x2,y1,y2, image = 'F:/Users/Brendan/Desktop/SolarProject/FITS/20131118/1600/aia_lev1_1600a_2013_11_18t18_00_16_12z_image_lev1.fits')
...
#ss.datacube(directory='%s' % (directory), date='%s' % (date), wavelength= wavelength, sub_reg_coords=[145,405,225,375], coords_type='arc', bin_frac=1)
...
ss.fft_avg(directory='%s' % (directory), date='%s' % (date), wavelength= wavelength, num_seg = 1)  # 3 seg for 20120923, 6 seg for rest
