# -*- coding: utf-8 -*-
"""
Created on Mon Sep 11 11:45:24 2017
...
def get_data_fill(arr_need, arr_rename, directory):
    ...
    for i in range(len(arr_need)):
        ...
        if wavelength == '1700' or wavelength == '1600' or wavelength == '304' or wavelength == '171' or wavelength == '193' or wavelength == '211':
