# -*- coding: utf-8 -*-
"""
Created on Fri Jan 20 08:55:40 2017
...
for l in range(101,102):
    ...
    for m in range(165,166):
        ...
        p6_range = (M2_high[5]-M2_low[5])/100000.   
                    ...
                    for p4 in range(1):
                        for p5 in range(1):
                            for p6 in range(100001):
                                ...
                                A2 = 1.405312476518233500e-09
                                n2 = 2.239502506015445871e+00
                                C2 = 2.938829788893690615e-04
                                P2 = 2.458691276650307417e-04
                                fp2 = -6.191295483972629299e+00
                                fw2 = M2_low[5] + p6_range*p6
        ...
        s_fit_gp_fullT = GaussPowerBase(f, A2,n2,C2,P2,fp2,fw2)
