# -*- coding: utf-8 -*-
"""
Created on Thu Jan 05 16:39:04 2017

@author: Brendan
"""
"""
### Still need to:
# need to set spectra-plot limits for all to fit on screen (even with different #freq)

# comment this and find way to put in automated module


## Updates:
# changed the heatmap to percentiles 

# changed t_interp - allows to accept floats or ints now

# update 1/13:
# modified some formatting stuff

# added multiple arrays to store interesting scatter points  -- or should they
# be imported from a separate file / array
"""
...
with h5py.File("F:/Users/Brendan/Desktop/SolarProject/hdf5/20130530_1600_2300_2600i_2200_3000j_rebin4_mpi.hdf5",'r') as f:
