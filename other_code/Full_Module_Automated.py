...
def heatmap(heatmaps, visual, date, wavelength, path_name):
    ...
    Example:
    ::
        fm.heatmap(heatmap = HEATMAPS, visual = VISUAL, date = '20130815',
...
# tried adding to the module, but doesn't work:
# wont stay connected to plot when called as a function
