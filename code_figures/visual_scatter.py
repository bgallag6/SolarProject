...
for i in range(2):
    ...
    rect = patches.Rectangle((610,1460), 70, 90, color='white', fill=True)
    ax.add_patch(rect)
    ax.text(620,1475, 'A', fontsize=25)
    rect = patches.Rectangle((580,580), 70, 90, color='white', fill=True)
    ax.add_patch(rect)
    ax.text(590,595, 'B', fontsize=25)   
    rect = patches.Rectangle((815,330), 70, 90, color='white', fill=True)
    ax.add_patch(rect)
    ax.text(825,345, 'C', fontsize=25)
    rect = patches.Rectangle((630,190), 70, 90, color='white', fill=True)
    ax.add_patch(rect)
    ax.text(640,205, 'D', fontsize=25)
