...
def onclick(event):
    ...
    if ixx > 1. and iyy > 1.:
        ...
        plt.text(0.006, 10**-0.84, r'$r [Gauss]$ = {0:0.3f}'.format(r), fontsize=font_size, fontname="Times New Roman")
        ...
        plt.text(0.006, 10**-1.06, r'$r [Lorentz]$ = {0:0.3f}'.format(r), fontsize=font_size, fontname="Times New Roman")
